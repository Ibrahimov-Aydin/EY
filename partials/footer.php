<footer class="footer">
	<div class="footer__container">
		<div class="footer__wrapper">
			...
			<nav class="footer__body">
				<ul class="footer__list">
					<li class="footer__item"><a href="about.php" class="footer__link">О компании</a></li>
					<li class="footer__item"><a href="portfolio.php" class="footer__link">Портфолио</a></li>
					<li class="footer__item"><a href="contacts.html" class="footer__link">Контакты</a></li>
				</ul>
			</nav>
			<div class="footer__inner">
				<a href="tel:+78121111111" class="footer__callback">+7 (812) 111-11-11</a>
				<ul class="social">
					<li>
						<a href="#">
		...
		<div class="footer__bottom">
			<p>©2025 Дизайн интерьера. Все права защищены.</p>
